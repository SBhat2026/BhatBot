...
const MAX_TOKENS = 4096;   // was 1600 → truncated the code-grounded desire JSON mid-object
                           // (observed stop_reason=max_tokens, ~3.9KB out). Still bounded; Opus
                           // reflection runs infrequently, so the extra output tokens are cheap.
