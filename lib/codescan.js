...
function docsBacklog(root) {
  const out = [];
  // ONE source (BACKLOG.md). Previously three overlapping roadmap docs, so the same item surfaced
  // two or three times and long-shipped work kept reappearing as "still pending".
