...
function saveRecipes(r) { try { fs.mkdirSync(path.dirname(RECIPE_PATH), { recursive: true }); fs.writeFileSync(RECIPE_PATH, JSON.stringify(r, null, 2)); } catch {} }
...
module.exports = { analyze, render, oneShot, loadRecipes, dataSignature, OUT_DIR };
