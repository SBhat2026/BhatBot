...
function contextBlock() {
  try {
    ...
    return '## ACTIVE PROJECT: ' + rec.name + '\n' + summary + recentLine;
  } catch { return ''; }
}

module.exports = {
  open, active, activeSlug, list, get, note, recordTurn, close, pause,
