...
// shouldEscalate) from HERE now. See PHASE2_NOTES.md.
//
...
// Kept in step with main.js MODEL_PRICES. This map drives the monthly cost CAP, so an overstated
// price does not merely misreport — it starves the agents. Opus 4.8 was carrying the 4.1-era
// $15/$75 (3× actual), and Haiku appeared only under a date-suffixed id, so the bare id the chains
// can also produce priced at zero. Both spellings are listed now.
const PRICES = { 'claude-sonnet-4-6': [3, 15], 'claude-opus-4-8': [5, 25], 'claude-fable-5': [10, 50],
