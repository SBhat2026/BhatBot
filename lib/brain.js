...
function createBrain({ dir } = {}) {
  ...
  return { upsertNode, upsertEdge, getNode, nodes, edges, neighbors, prune, confirm, stats, graphView, getMeta, setMeta, save, load, loadFailed: () => loadFailed, dir: base, _store: () => store };
}
