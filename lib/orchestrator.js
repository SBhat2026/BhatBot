...
const DEFAULT_SUIT_TOOLS = ['read_file', 'write_file', 'list_directory', 'run_shell', 'fetch_url', 'web_search', 'browser', 'screen_parse', 'vision_click', 'ui_inspect', 'ask_ai', 'save_memory', 'notify_user', 'generate_image', 'make_figure'];
