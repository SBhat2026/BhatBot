...
// Atomic: tmp + rename. This is a rebuildable cache, so the stakes are lower than the vault or the
// graph — but a truncated file still reads as corrupt on the next boot, and the cost of doing it
// right is one extra line.
